// ======================================================================
// P-Stat.v generated from TopDesign.cysch
// 09/04/2024 at 20:39
...
// VDAC8_v1_90(Data_Source=0, Initial_Value=128, Strobe_Mode=0, VDAC_Range=4, VDAC_Speed=0, Voltage=2048, CY_API_CALLBACK_HEADER_INCLUDE=, CY_COMMENT=, CY_COMPONENT_NAME=VDAC8_v1_90, CY_CONFIG_TITLE=VDAC_TIA, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=VDAC_TIA, CY_INSTANCE_SHORT_NAME=VDAC_TIA, CY_MAJOR_VERSION=1, CY_MINOR_VERSION=90, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.4, INSTANCE_NAME=VDAC_TIA, )
...
// TIA_v2_0(Capacitive_Feedback=3, Fcorner=567 kHz, Power=2, Resistive_Feedback=0, vdda_value=5, CY_API_CALLBACK_HEADER_INCLUDE=, CY_COMMENT=, CY_COMPONENT_NAME=TIA_v2_0, CY_CONFIG_TITLE=TIA, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=TIA, CY_INSTANCE_SHORT_NAME=TIA, CY_MAJOR_VERSION=2, CY_MINOR_VERSION=0, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.4, INSTANCE_NAME=TIA, )
module TIA_v2_0_1 (
    Iin,
    Vout,
    Vref);
...
// PWM_v3_30(CaptureMode=0, Clock_CheckTolerance=true, Clock_desired_freq=12, Clock_desired_freq_unit=6, Clock_divisor=1, Clock_FractDividerDenominator=0, Clock_FractDividerNumerator=0, Clock_FractDividerUsed=false, Clock_is_direct=false, Clock_is_divider=false, Clock_is_freq=true, Clock_minus_tolerance=5, Clock_ph_align_clock_id=, Clock_ph_align_clock_name=, Clock_plus_tolerance=5, Clock_source_clock_id=, Clock_source_clock_name=, Compare1_16=false, Compare1_8=true, Compare2_16=false, Compare2_8=false, CompareStatusEdgeSense=true, CompareType1=0, CompareType1Software=0, CompareType2=4, CompareType2Software=0, CompareValue1=12, CompareValue2=255, CONTROL3=0, ControlReg=true, CtlModeReplacementString=SyncCtl, CyGetRegReplacementString=CY_GET_REG8, CySetRegReplacementString=CY_SET_REG8, DeadBand=0, DeadBand2_4=0, DeadBand256=0, DeadBandUsed=0, DeadTime=1, DitherOffset=0, EnableMode=0, FF16=false, FF8=false, FixedFunction=false, FixedFunctionUsed=0, InterruptOnCMP1=false, InterruptOnCMP2=false, InterruptOnKill=false, InterruptOnTC=false, IntOnCMP1=0, IntOnCMP2=0, IntOnKill=0, IntOnTC=0, KillMode=0, KillModeMinTime=0, MinimumKillTime=1, OneCompare=true, Period=25, PWMMode=0, PWMModeCenterAligned=0, RegDefReplacementString=reg8, RegSizeReplacementString=uint8, Resolution=8, RstStatusReplacementString=sSTSReg_rstSts, RunMode=0, Status=false, TermMode_capture=0, TermMode_clock=0, TermMode_cmp_sel=0, TermMode_enable=0, TermMode_interrupt=0, TermMode_kill=0, TermMode_ph1=0, TermMode_ph2=0, TermMode_pwm=0, TermMode_pwm1=0, TermMode_pwm2=0, TermMode_reset=0, TermMode_tc=0, TermMode_trigger=0, TermVisibility_capture=false, TermVisibility_clock=true, TermVisibility_cmp_sel=false, TermVisibility_enable=false, TermVisibility_interrupt=false, TermVisibility_kill=false, TermVisibility_ph1=false, TermVisibility_ph2=false, TermVisibility_pwm=true, TermVisibility_pwm1=false, TermVisibility_pwm2=false, TermVisibility_reset=true, TermVisibility_tc=true, TermVisibility_trigger=true, TriggerMode=1, UDB16=false, UDB8=true, UseControl=true, UseInterrupt=false, UseStatus=false, VerilogSectionReplacementString=sP8, CY_API_CALLBACK_HEADER_INCLUDE=, CY_COMMENT=, CY_COMPONENT_NAME=PWM_v3_30, CY_CONFIG_TITLE=PWM_S, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=PWM_S, CY_INSTANCE_SHORT_NAME=PWM_S, CY_MAJOR_VERSION=3, CY_MINOR_VERSION=30, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.4, INSTANCE_NAME=PWM_S, )
module PWM_v3_30_2 (
    capture,
    clock,
    cmp_sel,
...
// IDAC8_v2_0(Current=15, Data_Source=0, Hardware_Enable=false, IDAC_Range=0, IDAC_Speed=2, Initial_Value=120, Polarity=0, Strobe_Mode=0, CY_API_CALLBACK_HEADER_INCLUDE=, CY_COMMENT=, CY_COMPONENT_NAME=IDAC8_v2_0, CY_CONFIG_TITLE=IDAC_calibrate, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=IDAC_calibrate, CY_INSTANCE_SHORT_NAME=IDAC_calibrate, CY_MAJOR_VERSION=2, CY_MINOR_VERSION=0, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.4, INSTANCE_NAME=IDAC_calibrate, )
module IDAC8_v2_0_3 (
    data,
    en,
    iOut,
...
// VDAC8_v1_90(Data_Source=0, Initial_Value=128, Strobe_Mode=0, VDAC_Range=4, VDAC_Speed=0, Voltage=2048, CY_API_CALLBACK_HEADER_INCLUDE=, CY_COMMENT=, CY_COMPONENT_NAME=VDAC8_v1_90, CY_CONFIG_TITLE=VDAC_Poise, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=VDAC_Poise, CY_INSTANCE_SHORT_NAME=VDAC_Poise, CY_MAJOR_VERSION=1, CY_MINOR_VERSION=90, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.4, INSTANCE_NAME=VDAC_Poise, )
...
// OpAmp_v1_90(Mode=0, Power=3, CY_API_CALLBACK_HEADER_INCLUDE=, CY_COMMENT=, CY_COMPONENT_NAME=OpAmp_v1_90, CY_CONFIG_TITLE=Opamp_Aux, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=Opamp_Aux, CY_INSTANCE_SHORT_NAME=Opamp_Aux, CY_MAJOR_VERSION=1, CY_MINOR_VERSION=90, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.4, INSTANCE_NAME=Opamp_Aux, )
...
module CharLCD_v2_20_9 ;
	...
	cy_psoc3_pins_v1_10
		#(.id("6330fff2-85d1-49a8-813c-de35d0821432/ed092b9b-d398-4703-be89-cebf998501f6"),
...
module top ;
	...
	wire [0:0] tmpOE__Counter_Electrode_net;
	wire [0:0] tmpFB_0__Counter_Electrode_net;
	wire [0:0] tmpIO_0__Counter_Electrode_net;
	wire [0:0] tmpINTERRUPT_0__Counter_Electrode_net;
	electrical [0:0] tmpSIOVREF__Counter_Electrode_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("cc3bcd7e-5dc0-48ea-9bf6-6aa082be1ada"),
		  ...
		  .input_buffer_sel(2'b00))
		Counter_Electrode
		 (.oe(tmpOE__Counter_Electrode_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Counter_Electrode_net[0:0]}),
		  .analog({Net_847}),
		  .io({tmpIO_0__Counter_Electrode_net[0:0]}),
		  .siovref(tmpSIOVREF__Counter_Electrode_net),
		  .interrupt({tmpINTERRUPT_0__Counter_Electrode_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Counter_Electrode_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

    // -- AMux AMux_TIA_input start -- ***
    // -- Mux A --
    
    cy_psoc3_amux_v1_0 AMux_TIA_input(
        .muxin({
            Net_1523,
            Net_1932
            }),
    ...
    defparam AMux_TIA_input.muxin_width = 2;
    defparam AMux_TIA_input.init_mux_sel = 2'h0;
    defparam AMux_TIA_input.one_active = 1;
    defparam AMux_TIA_input.connect_mode = 2;
    
    // -- AMux AMux_TIA_input end --

	wire [0:0] tmpOE__Working_Electrode_net;
	wire [0:0] tmpFB_0__Working_Electrode_net;
	wire [0:0] tmpIO_0__Working_Electrode_net;
	wire [0:0] tmpINTERRUPT_0__Working_Electrode_net;
	electrical [0:0] tmpSIOVREF__Working_Electrode_net;

	cy_psoc3_pins_v1_10
		#(.id("830c1cf8-6447-45c1-a307-1609af586bb0"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Working_Electrode
		 (.oe(tmpOE__Working_Electrode_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Working_Electrode_net[0:0]}),
		  .analog({Net_1523}),
		  .io({tmpIO_0__Working_Electrode_net[0:0]}),
		  .siovref(tmpSIOVREF__Working_Electrode_net),
		  .interrupt({tmpINTERRUPT_0__Working_Electrode_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Working_Electrode_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

    VDAC8_v1_90_0 VDAC_TIA (
        .data(8'b00000000),
        .strobe(1'b0),
        .vOut(Net_1271));
    defparam VDAC_TIA.Data_Source = 0;
    defparam VDAC_TIA.Initial_Value = 128;
    defparam VDAC_TIA.Strobe_Mode = 0;
    ...
    PWM_v3_30_2 PWM_S (
        ...
        .tc(Net_3878),
        .trigger(Net_529));
    defparam PWM_S.Resolution = 8;

    IDAC8_v2_0_3 IDAC_calibrate (
        .data(8'b00000000),
        .en(1'b0),
        .iOut(Net_1932),
        .ipolarity(1'b0),
        .strobe(1'b0));
    defparam IDAC_calibrate.Data_Source = 0;
    defparam IDAC_calibrate.Initial_Value = 120;
    defparam IDAC_calibrate.Strobe_Mode = 0;

	wire [0:0] tmpOE__Reference_Electrode_net;
	wire [0:0] tmpFB_0__Reference_Electrode_net;
	wire [0:0] tmpIO_0__Reference_Electrode_net;
	wire [0:0] tmpINTERRUPT_0__Reference_Electrode_net;
	electrical [0:0] tmpSIOVREF__Reference_Electrode_net;

	cy_psoc3_pins_v1_10
		#(.id("3d39ec19-0fe2-40b0-adca-ead8b6f7bf1d"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Reference_Electrode
		 (.oe(tmpOE__Reference_Electrode_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Reference_Electrode_net[0:0]}),
		  .analog({Net_3893}),
		  .io({tmpIO_0__Reference_Electrode_net[0:0]}),
		  .siovref(tmpSIOVREF__Reference_Electrode_net),
		  .interrupt({tmpINTERRUPT_0__Reference_Electrode_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Reference_Electrode_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
    ...
    VDAC8_v1_90_4 VDAC_Poise (
        .data(8'b00000000),
        .strobe(1'b0),
        .vOut(Net_1435));
    defparam VDAC_Poise.Data_Source = 0;
    defparam VDAC_Poise.Initial_Value = 128;
    defparam VDAC_Poise.Strobe_Mode = 0;

    // -- AMux AMux_electrode start -- ***
    // -- Mux A --
    
    cy_psoc3_amux_v1_0 AMux_electrode(
        .muxin({
            Net_3893,
            Net_847
            }),
    ...
    defparam AMux_electrode.muxin_width = 2;
    defparam AMux_electrode.init_mux_sel = 2'h0;
    defparam AMux_electrode.one_active = 1;
    defparam AMux_electrode.connect_mode = 0;
    
    // -- AMux AMux_electrode end --

    OpAmp_v1_90_5 Opamp_Aux (
        .Vminus(Net_585),
        .Vout(Net_847),
        .Vplus(Net_1435));
    defparam Opamp_Aux.Mode = 0;

    assign Net_527 = 1'h0;

	wire [0:0] tmpOE__P_M_net;
	wire [0:0] tmpFB_0__P_M_net;
	wire [0:0] tmpIO_0__P_M_net;
	wire [0:0] tmpINTERRUPT_0__P_M_net;
	electrical [0:0] tmpSIOVREF__P_M_net;
	...
	cy_psoc3_pins_v1_10
		...
		P_M
		 (.oe(tmpOE__P_M_net),
		  .y({Net_529}),
		  .fb({tmpFB_0__P_M_net[0:0]}),
		  .io({tmpIO_0__P_M_net[0:0]}),
		  .siovref(tmpSIOVREF__P_M_net),
		  .interrupt({tmpINTERRUPT_0__P_M_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__P_M_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

    ADC_DelSig_v3_30_6 ADC_DelSig (
        .aclk(1'b0),
        .eoc(Net_501),
        .mi(1'b0),
        .nVref(Net_3157),
	...
	wire [0:0] tmpOE__P_S_net;
	wire [0:0] tmpFB_0__P_S_net;
	wire [0:0] tmpIO_0__P_S_net;
	wire [0:0] tmpINTERRUPT_0__P_S_net;
	electrical [0:0] tmpSIOVREF__P_S_net;

	cy_psoc3_pins_v1_10
		#(.id("bec51811-1d9c-45ea-8abf-5b5e1d9ce397"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		...
		P_S
		 (.oe(tmpOE__P_S_net),
		  .y({Net_3579}),
		  .fb({tmpFB_0__P_S_net[0:0]}),
		  .io({tmpIO_0__P_S_net[0:0]}),
		  .siovref(tmpSIOVREF__P_S_net),
		  .interrupt({tmpINTERRUPT_0__P_S_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__P_S_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
